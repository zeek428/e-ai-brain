...
| 7 | 在需求管理页点击“全链路” | 弹窗一次展示需求、迭代版本、AI 任务、Review、PR/MR 快照、代码评审、Bug、发布和知识沉淀时间线；阶段进度区按需求、迭代版本、AI 任务、Review、PR/代码评审、Bug、发布和知识沉淀展示覆盖状态；PR/MR 快照区展示风险摘要、diff 文件树和 Review Checklist，不需要跳转多个页面。 |
