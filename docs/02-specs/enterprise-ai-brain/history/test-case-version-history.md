...
| 版本 | 日期 | 变更内容 | 作者 |
|------|------|----------|------|
| v1.1.967 | 2026-07-11 | 增加 Agent 自治循环、独立质量门禁、执行上下文、事务 Outbox/Inbox、执行资源 scope、生产部署安全、外部事件幂等、部署读模型和多模态知识版本治理验收 | Codex |
| v1.1.970 | 2026-07-09 | 补充系统设置邮件发送敏感配置二次确认验收：缺少确认返回明确错误且不泄露密钥 | Codex |
