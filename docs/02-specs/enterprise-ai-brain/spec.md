...
| v1.1.278 | 2026-06-11 | 增强插件连接测试诊断：完整展示最终请求 URL、query、脱敏 headers、Header 来源和远端响应摘要，拦截 `***` 占位请求并明确认证 Header 优先级 | Codex |
