...
| rd_work_items | 协作工作项 | 保存目标、负责人席位、输入输出契约、验收标准、状态、`resume_state`、暂停 attempt、解除条件、风险、优先级、关联 AI 任务、审核人、租约和幂等键。 |
