...
| 代码巡检 | code_inspection, scheduled_jobs | 周期性代码仓库质量、安全和规范巡检，按提交人沉淀报告、finding、通知反馈、严重问题 Bug 和治理概览 | 基于产品 Git 资源和插件扫描动作生成，关联产品、仓库、提交人、定时作业运行、Bug 和通知记录；治理概览从报告、finding、质量门禁和 Bug 关联状态聚合趋势、规则、仓库/分支/提交人排行和严重问题 SLA |
