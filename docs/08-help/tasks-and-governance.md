...
“每周 AI 客服洞察抽取”或“每周用户反馈洞察抽取”的“取数动作”只用于读取客服与反馈数据，不会显示会修改外部内容的“钉钉文档 - 更新内容”。需要把洞察同步到钉钉时，在“结果动作”点击“新增钉钉文档更新”，选择已配置的“钉钉文档 - 更新内容”动作，填写文档链接或 ID，并选择追加或覆盖。系统先完成 AI 分析并生成 `dingtalk_markdown`，再执行文档写入，避免用未生成的内容调用外部写操作。
