    ...
    articles: [
        ...
        sections: [
          {
            ...
            body: [
              ...
              '确认版本范围后，从版本发起研发协作；运行会冻结需求修订、最终策略快照和仓库范围，后续范围变化需要走人工范围变更和新代次协作。',
      ...
      },
      {
        ...
        screenshots: [
          {
            alt: '研发协作页面截图',
            caption: '研发协作页展示冻结策略、工作项依赖、风险和人工决策，并止步于待发布交付证据。',
        ...
        sections: [
          {
            heading: '如何推进',
            body: [
              '选择已完成归集的版本并填写范围版本号启动协作。页面会显示本次冻结的策略快照，后续修改当前策略不会改变已启动运行。',
              '“工作项 DAG”按负责人、依赖、优先级、风险和状态展示可并行工作。只有前置工作满足且岗位席位有效时，工作项才能被领取。',
