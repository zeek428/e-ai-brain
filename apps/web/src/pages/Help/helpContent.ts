...
export const helpGroups: HelpGroup[] = [
        ...
        sections: [
          {
            ...
            body: [
              ...
              '需求测试完成后进入待发布，版本发布前需要在日志监控页发起部署并登记成功结果。',
  ...
  },
  {
    ...
    articles: [
      {
        key: 'devops',
        keywords: ['日志监控', '部署', '运维部署', 'Jenkins', 'GitLab', '发布', '在线日志'],
        role: '研发治理、运维或管理员',
        ...
        sections: [
          {
            heading: '管理重点',
            body: [
              '按产品查看代码提交、运维部署、构建发布和在线日志趋势。',
              '测试完成或待发布需求可通过“发起部署”创建部署单，部署成功后需求进入已发布。',
              '部署失败或回滚会把需求退回待发布，并生成部署失败来源的 Bug。',
              '异常波动应下钻到版本、任务、部署单或代码巡检记录确认根因。',
            ],
          },
        ],
      },
