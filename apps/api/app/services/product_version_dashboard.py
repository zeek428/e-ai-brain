...
from app.services.product_version_delivery_overview import (
    SEVERE_CODE_RISKS,
    version_delivery_stage_overview,
    version_governance_conclusion,
)
from app.services.product_version_delivery_overview import (
    failed_release as _failed_release,
)
from app.services.product_version_delivery_overview import (
...
def product_version_dashboard_response(
    *,
    ...
    governance_conclusion = version_governance_conclusion(
        blockers=blockers,
        branch_quality_governance=branch_quality_governance,
        status_impact=status_impact,
        summary=summary,
    )
    delivery_stage_overview = version_delivery_stage_overview(
        blockers=blockers,
        branch_configs=branch_configs,
        branch_quality_governance=branch_quality_governance,
        bugs=bugs,
    ...
    evidence_coverage = version_evidence_coverage(
