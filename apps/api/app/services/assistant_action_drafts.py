...
from app.services.assistant_action_draft_governance import assistant_action_draft_governance
from app.services.assistant_action_draft_preview_helpers import (
    add_issue as _add_issue,
)
from app.services.assistant_action_draft_preview_helpers import (
    draft_source_plugin_action as _draft_source_plugin_action,
)
from app.services.assistant_action_draft_preview_helpers import (
    draft_source_resource as _draft_source_resource,
)
from app.services.assistant_action_draft_preview_helpers import (
    finalize_validation as _finalize_validation,
)
from app.services.assistant_action_draft_preview_helpers import (
    generic_create_draft_preview as _generic_create_draft_preview,
)
from app.services.assistant_action_draft_preview_helpers import (
    string_ids as _string_ids,
)
from app.services.assistant_action_draft_preview_helpers import (
    validate_collection_ref as _validate_collection_ref,
)
from app.services.assistant_action_draft_preview_helpers import (
    validate_enum as _validate_enum,
)
from app.services.assistant_action_draft_preview_helpers import (
    validate_plugin_connection_ref as _validate_plugin_connection_ref,
)
from app.services.assistant_action_draft_preview_helpers import (
    with_action_permission_preview as _with_action_permission_preview,
)
...
def public_assistant_action_draft(
    ...
    *,
    ...
    public["governance"] = assistant_action_draft_governance(
        draft,
