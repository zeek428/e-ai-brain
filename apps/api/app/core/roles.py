...
ROLE_DEFINITIONS: list[dict[str, Any]] = [
    {
        ...
        "menu_scope": ["系统管理", "审计与运行", "运维部署", "产品资产", "需求交付", "任务中心"],
        "name": "系统管理员",
        "permissions": [
            "system.roles.read",
            "system.roles.manage",
    ...
    },
    {
        ...
        "category": "readonly",
        "code": "viewer",
        "description": "只能查看有权限访问的产品上下文、业务列表、任务结果、知识和看板摘要。",
        "data_scope": "授权范围内的产品、列表、详情、任务结果、知识检索结果和看板摘要。",
        ...
        "menu_scope": ["首页 IT 团队看板", "产品管理", "授权业务列表", "知识检索"],
        "name": "查看者",
        "permissions": [
            "product.read",
            "requirement.read",
    ...
    {
        "business_roles": ["开发工程师"],
        "category": "delivery",
        "code": "developer",
        "description": "负责授权产品范围内的研发执行、Bug 处理和研发知识沉淀。",
        "data_scope": "授权产品、版本或模块下的任务、Bug、研发知识和 DevOps 只读数据。",
        "decision_scope": "研发执行和 Bug 处理；不替代产品或发布决策。",
        "is_assignable": True,
        "limitations": [
            "不能维护系统用户、角色或模型网关密钥。",
            "不能审批需求或确认发布决策。",
    ...
    {
        "business_roles": ["测试负责人"],
        "category": "testing",
        "code": "test_owner",
        "description": "负责测试计划、测试执行、自动化测试结果确认和 Bug 验证闭环。",
        "data_scope": "授权产品、版本或模块下的测试任务、Bug、测试证据和相关知识。",
        "decision_scope": "测试策略、测试执行结论和 Bug 验证决策。",
        "is_assignable": True,
        "limitations": [
            "不能维护系统用户、角色或模型网关密钥。",
            "不能替代发布负责人做发布确认。",
        ],
        "menu_scope": ["研发任务", "Bug 管理", "运维部署", "首页 IT 团队看板"],
        "name": "测试负责人",
        "permissions": [
            "task.read",
            "task.create",
    ...
    },
    {
        ...
        "category": "testing",
        "code": "tester",
        "description": "负责执行测试、提交验证结果并跟进授权范围内的 Bug。",
        "data_scope": "授权产品、版本或模块下的测试任务、Bug 和只读知识。",
        "decision_scope": "测试执行记录和 Bug 验证结果。",
        "is_assignable": True,
        "limitations": [
            "不能审批需求、发布或系统配置。",
            "只能在授权范围内验证 Bug。",
    ...
    {
        "business_roles": ["发布负责人"],
        "category": "release",
        "code": "release_owner",
        "description": "负责发布准备度、发布确认和上线后分析闭环。",
        "data_scope": "授权产品、版本下的发布准备度、Bug、任务结果和 DevOps 指标。",
        "decision_scope": "发布准备确认、发布决策和上线后分析确认。",
        "is_assignable": True,
        "limitations": [
            "不能维护系统用户、角色或模型网关密钥。",
            "不能替代产品负责人审批需求。",
        ],
        "menu_scope": ["研发任务", "Bug 管理", "日志监控", "运维部署", "首页 IT 团队看板"],
        "name": "发布负责人",
        "permissions": [
            "task.read",
            "bug.read",
